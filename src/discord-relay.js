...
// 하루 봇 ID — .env의 HARU_BOT_ID 또는 아래 기본값
const HARU_BOT_ID = process.env.HARU_BOT_ID || '';
...
client.on('messageCreate', async (msg) => {
  ...
  // 다른 봇(Klaude, 니노 등) 메시지 — 해당 채널 pending 제거 후 tmux로 전달
...
// --- 프레즌스(상태) 관리 ---
const STATUS_FILE = '/tmp/haru-status';
